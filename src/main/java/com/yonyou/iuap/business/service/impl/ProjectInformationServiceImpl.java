...
public class ProjectInformationServiceImpl implements ProjectInformationService {
	...
	public PageList querPage(int index, int pageSize, long regionId, String projectName) throws Exception {
		...
		List<ProjectInfoVO> list = projectInformationMapper.queryPage(index, pageSize, regionId, projectName);
		int pageNum = projectInformationMapper.queryCount(regionId, projectName);
